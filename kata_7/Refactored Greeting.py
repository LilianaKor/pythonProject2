...
class Person:
    ...
    def greet(self, your_name: str) -> str:
        greeting: str = f'Hello {your_name}, my name is {self.name}'
        return greeting

# The following code could use a bit of object-oriented artistry. While it's a simple method and works just fine as
# it is, in a larger system it's best to organize methods into classes/objects. (Or, at least, something similar depending
# on your language)
#
